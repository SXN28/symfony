...
class getTrackRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\TrackRepository'])) {
            return $container->privates['App\\Repository\\TrackRepository'];
        }

        return $container->privates['App\\Repository\\TrackRepository'] = new \App\Repository\TrackRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
