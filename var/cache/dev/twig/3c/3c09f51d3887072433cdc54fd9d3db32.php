    ...
    ";
        ...
        <div class=\"row\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["artist"]) {
                ...
                yield "                <div class=\"col-md-6 col-lg-4 mb-4\">
                    <div class=\"card shadow-sm\">
                        <div class=\"card-body d-flex flex-column\">
                            <h5 class=\"card-title\">
                                <a href=\"http://127.0.0.1:8000/artist/";
                // line 79
                ...
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["artist"], "name", [], "any", false, false, false, 79), "html", null, true);
                yield "</a>
                            </h5>
                            ";
                // line 81
                if ( !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["artist"], "images", [], "any", false, false, false, 81))) {
                    // line 82
                    yield "                                <img src=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["artist"], "images", [], "any", false, false, false, 82), 0, [], "array", false, false, false, 82), "url", [], "any", false, false, false, 82), "html", null, true);
...
";
    ...
    {
        return array (  208 => 90,  204 => 88,  195 => 84,  189 => 82,  187 => 81,  180 => 79,  174 => 75,  170 => 74,  164 => 72,  162 => 71,  159 => 70,  155 => 68,  144 => 63,  139 => 60,  130 => 58,  126 => 57,  119 => 53,  116 => 52,  110 => 50,  108 => 49,  104 => 47,  100 => 46,  94 => 44,  92 => 43,  48 => 1,);
    }
            ...
            {% for artist in artists %}
                <div class=\"col-md-6 col-lg-4 mb-4\">
                    <div class=\"card shadow-sm\">
                        <div class=\"card-body d-flex flex-column\">
                            <h5 class=\"card-title\">
                                <a href=\"http://127.0.0.1:8000/artist/{{ artist.id }}\" class=\"text-white\">{{ artist.name }}</a>
                            </h5>
