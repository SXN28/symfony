...
class __TwigTemplate_d2b362a0720729afd0ca6fbf7da79b94 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>Mes Favoris</h1>

    ";
        // line 8
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["favoriteTracks"]) || array_key_exists("favoriteTracks", $context) ? $context["favoriteTracks"] : (function () { throw new RuntimeError('Variable "favoriteTracks" does not exist.', 8, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["track"]) {
            ...
            <form action=\"";
            // line 11
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_remove_favorites", ["trackId" => CoreExtension::getAttribute($this->env, $this->source, $context["track"], "id", [], "any", false, false, false, 11)]), "html", null, true);
            yield "\" method=\"post\">
    ...
    {
        return array (  126 => 16,  116 => 11,  112 => 10,  109 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
