...
class getTrackControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\TrackController'] = $instance = new \App\Controller\TrackController(new \App\Service\AuthSpotifyService($a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $container->getEnv('SPOTIFY_CLIENT_ID'), $container->getEnv('SPOTIFY_CLIENT_SECRET')), $a, new \App\Factory\TrackFactory());
